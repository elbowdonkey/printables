...
module archimedesSpiral(){
    scale([0.02, 0.02, 0.04]) linear_extrude(height=150)
    2dgraph([0, 360*3], 100, steps=200, polar=true);
}
...
function polarX(theta) = cos(theta)*d2r(theta);
function polarY(theta) = sin(theta)*d2r(theta);
